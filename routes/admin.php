...
Route::post('blog/update-featured', [BlogController::class, 'updateFeatured'])->name('blog.update_featured');
...
Route::post('/category/status_update', [ProductCategoryController::class, 'updateStatus'])->name('category.status_update');
