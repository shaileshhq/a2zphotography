...
class FrontController extends Controller
{
    ...
    public function our_project()
    {
        ...
        return view('frontend.our-project',compact('project'));
    }
    ...
    {
        $blog = Blog::where('delete_status', 0)->where('status',1)->orderBy('id', 'DESC')->paginate(10);
        $blogs = Blog::where('delete_status', 0)->where('status',1)->orderBy('id', 'DESC')->limit(5)->get();
        return view('frontend.blog',compact('blog','blogs'));
    }
    public function blog_details($id)
    {

        $blog = Blog::where('delete_status', 0)->orderBy('id', 'DESC')->limit(5)->get();
        $blog_detail = Blog::where('slug' , $id)->first();
        return view('frontend.blog-details',compact('blog_detail','blog'));
    }
    /**
