					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Brand Support No.</li>
							</ol>
						</nav>
					</div>
				</div>
									...
									<div class="row">
										<div class="col-lg-6 mb-3">
											...
											<input type="text" class="form-control" name="title"
												placeholder="Enter title" value="{{$support->title}}">
										</div>
										<div class="col-lg-6 mb-3">
											<label for="inputProductDescription" class="form-label">Contact No.</label>
											<input type="number" class="form-control" name="short_desc"
												placeholder="Enter Contact No." value="{{$support->short_desc}}">
										</div>
										<div class="col-lg-6 mb-3">
