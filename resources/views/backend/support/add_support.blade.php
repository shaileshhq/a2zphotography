...
<body>
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Brand Customer Care No.</li>
							</ol>
						</nav>
					</div>
				</div>
							...
							<div class="border border-3 p-4 rounded">
								...
								@csrf
									<div class="row">
										...
										<div class="col-lg-6 mb-3">
											<label for="inputProductDescription" class="form-label">Contact No.</label>
											<input type="number" class="form-control" name="short_desc" id="inputProductTitle"
	...
	<script src="{{ asset('backend_css/assets/plugins/Drag-And-Drop/dist/imageuploadify.min.js')}}"></script>
	<script>
