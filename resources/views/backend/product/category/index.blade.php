		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Wedding Photography </div>
					<div class="ps-3">
					...
					<div class="card-header">
						<div class="row align-items-center">
							...
							<div class="col-lg-3 col-xl-3">
								<a href="{{route('category.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Category</a>
							</div>
						</div>
					</div>
					<div class="card-body">
						<div class="table-responsive">
							<table class="table mb-0">
								...
								<tbody>
									...
									<tr>
										<td>{{$i++}}</td>
										<td><img src="../public/category/{{$item->image}}" style="width:150px;"></td>
										<td>{{$item->title}}</td>
										<td>
										<div class="form-check form-switch">
        									<input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" value="{{$item->id}}" @if($item->is_home==1) checked @endif onchange="update_status(this)">
										...
										<td>
											<div class="d-flex order-actions">
												...
												<a href="{{route('category.delete',$item->id)}}" class="ms-3"><i class='bx bxs-trash'></i></a>
											</div>
										</td>
									</tr>
									@endforeach
	...
	<script src="{{ asset('backend_css/assets/js/app.js')}}"></script>
	 <script>
        ...
        function update_status(el) {
            ...
            $.post('{{ route('category.status_update') }}', {
                _token: '{{ csrf_token() }}',
                id: el.value,
                status: status
            }, function(data) {
