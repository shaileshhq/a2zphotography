								...
								@csrf
									<div class="row">
									    <div class="col-lg-6 mb-3">
											<label for="inputProductTitle" class="form-label">Category</label><br>
											<select class="single-select" name="category">
												<option value="">Add Category</option>
                                                {{-- @php
													$prod=App\Models\ProductCategory::where('delete_status',0)->get();
												@endphp --}}
												@foreach ($prod as $cat)
                                        ...
                                        <div class="col-lg-6 mb-3">
											<label for="inputProductTitle" class="form-label">Discounted Price</label>
