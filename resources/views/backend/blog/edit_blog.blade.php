...
<body>
									...
									<div class="row">
										...
										<div class="col-lg-6 mb-3">
											<div class="form-group">
												...
												<input type="date" class="form-control" name="date"
													placeholder="Enter Campaign title"  value="{{$blog->date}}">
											</div>
										</div>
                                        <div class="col-lg-6 mb-3">
										...
										<div class="col-lg-12 mb-3">
											...
											<input type="text" class="form-control" name="short_desc"
												placeholder="Enter Short Desc" value="{{$blog->short_desc}}">
										...
										{{-- <div class="col-lg-6 mb-3">
											...
											<input type="text" class="form-control" name="author_name" id="author_name"
												placeholder="Enter Author Name" value="{{$blog->author_name}}" required>
										</div>
	...
	<!--end wrapper-->
		...
		<script src="{{ asset('backend_css/assets/js/ckeditor.js')}}"></script>
    <script>
    ClassicEditor
