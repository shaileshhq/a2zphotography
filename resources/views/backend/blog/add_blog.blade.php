...
<head>
	...
	<title>Innovative Consultants | Admin Dashboard</title>
</head>
		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Innovative Consultants</div>
					<div class="ps-3">
								...
								@csrf
									<div class="row">
										...
										<div class="col-lg-12 mb-3">
											...
											<input type="text" class="form-control" name="short_desc" id="inputProductTitle"
