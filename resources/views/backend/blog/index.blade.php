...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('backend_css/assets/plugins/notifications/css/lobibox.min.css')}}" />
    <!-- Theme Style CSS -->
...
<body>
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    <div class="breadcrumb-title pe-3">Photography</div>
                    <div class="ps-3">
                ...
                @if (Session::has('success'))
                    <div
                        class="alert border-0 bg-white border-start border-5 border-success alert-dismissible fade show py-2">
                ...
                @if (Session::has('update'))
                    <div
                        class="alert border-0 bg-white border-start border-5 border-info alert-dismissible fade show py-2">
                        <div class="d-flex align-items-center">
                ...
                @if (Session::has('error'))
                    <div
                        class="alert border-0 bg-white border-start border-5 border-danger alert-dismissible fade show py-2">
                        <div class="d-flex align-items-center">
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-3 col-xl-2">
                                <a href="{{ route('blog.create') }}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i
                                        class="bx bxs-plus-square"></i>Add Blog</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($blog as $item)
                                        <tr>
                                            ...
                                            {{-- <td>
											@php
                                            $cat_title=App\Models\BlogCategory::where('id',$item->category_id)->first();
											@endphp
                                            ...
                                            {{-- <td>
											{{optional($item->blog)->title}}
										</td> --}}



                                            <td><img src="../public/blog/{{ $item->image }}" style="width:150px;">
                                            </td>
                                            <td>{{ $item->title }}</td>
                                            ...
                                            <td>
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" onchange="update_featured(this)"
                                                        type="checkbox" role="switch" value="{{ $item->id }}"
                                            ...
                                            <td>
                                                <div class="d-flex order-actions">
                                                    ...
                                                    <form action="{{ route('blog.destroy', $item->id) }}"
                                                        ...
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="ms-3"><i
    ...
    <!--app JS-->
    <script src="{{ asset('backend_css/assets/plugins/notifications/js/lobibox.min.js')}}"></script>
    <script src="{{ asset('backend_css/assets/plugins/notifications/js/notifications.min.js')}}"></script>
    ...
    <script>
        ...
        function update_featured(el) {
            ...
            $.post('{{ route('blog.update_featured') }}', {
                _token: '{{ csrf_token() }}',
                id: el.value,
                status: status
            }, function(data) {
                if (data == 1) {
                    round_success_noti('success', 'featured');
                } else {
                    round_success_noti('error', 'un featured');
                }
            });
        }
    </script>
