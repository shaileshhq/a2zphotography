					...
					<div class="card-header">
						<div class="row align-items-center">
							...
							<div class="col-lg-3 col-xl-2">
								<a href="{{ route('slider.create') }}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Slider</a>
							</div>
						</div>
					</div>
					<div class="card-body">
						<div class="table-responsive">
							<table class="table mb-0">
								...
								<tbody>
									...
									<tr>
										<td>{{$i++}}</td>
										<td><img src="../public/slider/{{$item->image}}" style="width:150px;"></td>
										<td>{{$item->title}}</td>
										<td>
