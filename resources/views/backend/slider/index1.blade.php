...
<head>
	...
	{{-- <link href="{{ asset('backend_css/assets/plugins/datatable/css/dataTables.bootstrap5.min.css')}}" rel="stylesheet" /> --}}
	<!-- loader-->
	...
	<title>Wedding Photography  | Varanasi, India | Admin Dashboard</title>
</head>
...
<body>
		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">The Psychologists</div>
					<div class="ps-3">
					...
					<div class="card-header">
						<div class="row align-items-center">
							...
							<div class="col-lg-3 col-xl-2">
								<a href="{{ route('slider.create') }}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>New Product</a>
							</div>
						</div>
					</div>
					<div class="card-body">
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
								...
								<tbody>
									...
									<tr>
										<td>{{$i++}}</td>
										<td><img src="/slider/{{$item->image}}" style="width:150px;"></td>
										<td>{{$item->title}}</td>
										<td>{{$item->short_desc}}</td>
										<td>
										<div class="d-flex order-actions">
												<a href="{{ route('slider.edit', $item->id) }}" class=""><i class='bx bxs-edit'></i></a>
												<a href="{{route('slider.delete', $item->id)}}" class="ms-3"><i class='bx bxs-trash'></i></a>
											</div>
										</td>
									</tr>
									@endforeach
	...
	{{-- <script src="{{ asset('backend_css/assets/plugins/datatable/js/jquery.dataTables.min.js')}}"></script>
	<script src="{{ asset('backend_css/assets/plugins/datatable/js/dataTables.bootstrap5.min.js')}}"></script> --}}
	<script>
